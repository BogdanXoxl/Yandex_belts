...
public:
    ...
    Rational(int numerator, int denominator):numerator(numerator/gcd(numerator, denominator) * (denominator<0?-1:1)),
                                             denominator(denominator/gcd(numerator, denominator) * (denominator<0?-1:1)){}
